<template>
    <div class="todo-item">
        ...
        <div class="todo-body">
            <ul class="clearfix">
                <li class="left width-half todo-button" :class="[state=='todo'? 'todo-button-active':'']"
                    @click="toggleStatus">待办
                </li>
                <li class="left width-half todo-button" :class="[state=='done'? 'todo-button-active':'']"
                    @click="toggleStatus">完成
                </li>
            </ul>
