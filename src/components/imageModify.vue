<template>
  <div class="image">
    <canvas id="canvas" @click="mosaicImage" data-src="https://ss0.baidu.com/73x1bjeh1BF3odCf/it/u=2844908530,3679402489&fm=85&s=E2731ED0626A6D0D70ABEC40030060FB" width="800" height="600"></canvas>
  </div>
</template>
